...
class DashboardDetailView extends StatefulWidget {
  final Map<String, dynamic> mapData;

  const DashboardDetailView({super.key, required this.mapData});

  @override
  State<DashboardDetailView> createState() => _DashboardDetailViewState();
}

class _DashboardDetailViewState extends State<DashboardDetailView> {
